...
2. Включай [строгий режим](https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Strict_mode). На дворе 2021 год, в конце концов.
...
_Еще одно плохое решение из одного реального продакшна_
